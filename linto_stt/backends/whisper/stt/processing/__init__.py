...
from linto_stt.backends.whisper.stt import USE_CTRANSLATE2, USE_ACCURATE, VAD, logger, set_num_threads, NUM_THREADS
...
alignment_model = get_alignment_model(
    os.environ.get("alignment_model"), language)
if alignment_model:
    logger.info(
    ...
    alignment_model = load_alignment_model(
        alignment_model, device=device, download_root="/opt")
