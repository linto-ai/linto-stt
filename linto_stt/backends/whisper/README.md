...
<table border="0">
 ...
 <tr>
    <td colspan="3"><b> [ct2/faster_whisper](linto_stt/backends/whisper/Dockerfile.ctranslate2) </b></td>
    <td><b> [torch/whisper_timestamped](linto_stt/backends/whisper/Dockerfile.torch) </b></td>
 </tr>
 <tr>
    <td><b>int8</b></td>
    <td><b>float16</b></td>
...
cd linto-stt
docker build . -f linto_stt/backends/whisper/Dockerfile.ctranslate2 -t linto-stt-whisper:latest
```
or
...
An example of .env file is provided in [linto_stt/backends/whisper/.envdefault](https://github.com/linto-ai/linto-stt/blob/master/linto_stt/backends/whisper/.envdefault).
